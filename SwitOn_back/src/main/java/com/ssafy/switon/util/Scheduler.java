...
public class Scheduler {
	...
	public void everyMinute() {
		Timestamp timestamp = new Timestamp(System.currentTimeMillis() + (1000 * 10 - (1000 * 60 * 10)));
		...
		Timestamp nowStart = new Timestamp(System.currentTimeMillis() - (1000 * 10));
		Timestamp nowEnd = new Timestamp(System.currentTimeMillis() + (1000 * 10));
		
		String resultMsg2 = notificationService.noticeSchedule(tenMinutesStart, tenMinutesEnd);
		if(resultMsg2 != null) {
			System.out.println(resultMsg2);
		}
		String resultMsg3 = notificationService.noticeSchedule2(nowStart, nowEnd);
		if(resultMsg3 != null) {
